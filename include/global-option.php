		...
		function tourmaster_plugin_option_top_file_write( $ret, $slug ){
			...
			if( !empty($general['item-padding']) ){
				...
				if( !empty($margin) && is_numeric($margin) ){
					$margin -= 1;
					$ret .= '.tourmaster-body .tourmaster-tour-item .gdlr-core-flexslider.gdlr-core-with-outer-frame-element .flex-viewport, '; 
					$ret .= '.tourmaster-body .tourmaster-room-item .gdlr-core-flexslider.gdlr-core-with-outer-frame-element .flex-viewport{ '; 
					$ret .= 'padding-top: ' . $margin . 'px; margin-top: -' . $margin . 'px; padding-right: ' . $margin . 'px; margin-right: -' . $margin . 'px; ';
					$ret .= 'padding-left: ' . $margin . 'px; margin-left: -' . $margin . 'px; padding-bottom: ' . $margin . 'px; margin-bottom: -' . $margin . 'px; ';
					$ret .= '}';
				}
			}
					...
					'options' => array(
						...
						'feature-settings' => array(
							...
							'options' => array(
								...
								// 'enable-car' => array(
								// 	'title' => esc_html__('Enable Car', 'tourmaster'),
								// 	'type' => 'checkbox',
								// 	'default' => 'enable'
								// )
							)
							...
							'options' => array(
								...
								'top-bar-login-style' => array(
									...
									'options' => array(
										...
										'style-1-2' => esc_html__('Style 1 (Name Hidden)', 'tourmaster'),
										'style-2' => esc_html__('Style 2', 'tourmaster')
									)
								),
								'top-bar-sign-up' => array(
									'title' => esc_html__('Enable Top Bar Sign Up', 'tourmster'),
									'type' => 'checkbox',
									'default' => 'enable'
								)
							)
							...
							'options' => array(
								...
								'user-page-style' => array(
									...
									'options' => array(
										'style-1' => esc_html__('Style 1', 'tourmaster'),
										'style-2' => esc_html__('Style 2', 'tourmaster'),
										'style-2-2' => esc_html__('Style 2 - 2', 'tourmaster')
									)
								),
								'user-top-bar-navigation-font-weight' => array(
									'title' => esc_html__('User Top Bar Navigation Font Weight', 'tourmaster'),
									'type' => 'text',
									'data-type' => 'text',
									'selector' => '.tourmaster-user-top-bar, .tourmaster-user-top-bar-nav{ font-weight: #gdlr#; }'
								),
...
'.tourmaster-user-template-style-2 .tourmaster-user-navigation .tourmaster-user-navigation-item a:hover svg, ' .
'.tourmaster-user-template-style-2 .tourmaster-user-navigation .tourmaster-user-navigation-item.tourmaster-active svg{ fill: #fff; }',
									'default' => '#485da1',
								),
							...
							'options' => array(
								...
								'user-template-navigation-text' => array(
									...
									'selector' => '.tourmaster-user-navigation .tourmaster-user-navigation-item a, .tourmaster-user-navigation .tourmaster-user-navigation-item a:hover{ color: #gdlr#; }' . 
										'.tourmaster-user-navigation .tourmaster-user-navigation-item a svg{ fill: #gdlr#; }',
									'default' => '#7d7d7d',
								),
							...
							'options' => array(
								...
								'tourmaster-input-box-border' => array(
									...
									'selector' => '.tourmaster-form-field.tourmaster-with-border input[type="text"], .tourmaster-form-field.tourmaster-with-border input[type="email"], ' .
										'.tourmaster-form-field.tourmaster-with-border .tourmaster-combobox-list-display, .tourmaster-form-field .tourmaster-combobox-list-wrap ul, .tourmaster-form-field .tourmaster-combobox-list-wrap ul li, ' .
					...
					'options' => array(
						...
						'plugins' => array(
							...
							'options' => array(
								...
								'gdlr-travel' => array(
									'title' => esc_html__('GDLR Travel', 'tourmaster'),
									'type' => 'checkbox',
									'default' => 'enable',
									'description' => esc_html__('Disable this if the "GDLR Travel" is already included on your site.', 'tourmaster'),
								)
