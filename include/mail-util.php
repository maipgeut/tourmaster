		...
		function tourmaster_send_email_invoice( $tid ){
			...
			if( !empty($result->pricing_info) ){
				...
				echo '</div>'; // tourmaster-invoice-total-price
								...
								echo '<span style="width: 100%;" >' . esc_html__('Additional Information', 'tourmaster') . '</span>'; // tourmaster-head
								echo '</div>'; // tourmaster-invoice-price-head
								$pickup_time = get_field('pickuptime', $result->tour_id);
								$notas_adicionales = get_field('notas_adicionales', $result->tour_id);
								$jefe_de_operaciones = get_field('jefe_de_operaciones', $result->tour_id);
								$terminos_y_condiciones = get_field('terminos_y_condiciones', $result->tour_id);
								
								echo '<span style="display:block;font-size:13px; padding-top: 20px;">'.  $pickup_time . '</span>';
								echo '<span style="display:block;font-size:13px; padding-top: 20px;">'.  $notas_adicionales . '</span>';
								echo '<span style="display:block;font-size:13px; padding-top: 20px;">'.  $jefe_de_operaciones . '</span>';
								echo '<span style="display:block;font-size:13px; padding-top: 20px;">'.  $terminos_y_condiciones . '</span>';
